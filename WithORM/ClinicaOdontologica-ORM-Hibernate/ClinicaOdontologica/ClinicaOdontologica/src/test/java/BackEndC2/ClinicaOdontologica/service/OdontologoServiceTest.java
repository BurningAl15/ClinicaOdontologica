...
public class OdontologoServiceTest {
    ...
    public void guardarOdontologo(){
        Odontologo odontologo = new Odontologo("Alicia","Torres","1111111");
    ...
    public void actualizarOdontologoTest(){
        ...
        if(odontologoBuscado.isPresent()){
            odontologoBuscado.get().setApellido("Torres Torres");
        }
        odontologoService.actualizarOdontologo(odontologoBuscado.get());
        
        assertEquals("Torres Torres",odontologoBuscado.get().getApellido());
    }    
